...
import com.meiqia.meiqiasdk.util.MQStatusBarUtil;
 ...
 */
public abstract class MQBaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBar(getResources().getColor(R.color.mq_white));
    ...
    protected void setStatusBar(int color) {
        //设置状态栏颜色
        MQStatusBarUtil.setColorNoTranslucent(this, color);
        MQStatusBarUtil.setDarkStatusIcon(MQBaseActivity.this,true);
    }
