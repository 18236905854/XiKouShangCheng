...
public class SlidingLayout extends FrameLayout{
    ...
    private void init(Context context, AttributeSet attrs){
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.izd_SlidingLayout);
        mBackgroundViewLayoutId = a.getResourceId(R.styleable.izd_SlidingLayout_background_view, mBackgroundViewLayoutId);
        mSlidingMode = a.getInteger(R.styleable.izd_SlidingLayout_sliding_mode,SLIDING_MODE_BOTH);
        mSlidingPointerMode = a.getInteger(R.styleable.izd_SlidingLayout_sliding_pointer_mode,SLIDING_POINTER_MODE_MORE);
        mSlidingTopMaxDistance = a.getDimensionPixelSize(R.styleable.izd_SlidingLayout_top_max,SLIDING_DISTANCE_UNDEFINED);
        a.recycle();
