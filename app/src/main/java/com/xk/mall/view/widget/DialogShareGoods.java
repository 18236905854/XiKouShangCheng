...
public class DialogShareGoods extends BottomSheetDialog implements View.OnClickListener, UMShareListener {
    ...
    public DialogShareGoods(@NonNull Context context) {
        super(context);
        ...
        LinearLayout llPage = findViewById(R.id.ll_share_cut_page);
        llWeixin.setOnClickListener(this);
        llCircle.setOnClickListener(this);
        llSina.setOnClickListener(this);
        llPage.setOnClickListener(this);
    }

    public DialogShareGoods(@NonNull Context context, ShareBean shareBean) {
        super(context);
        this.mContext = context;
        ...
        if(SPUtils.getInstance().getBoolean(Constant.IS_LOGIN)){
            ...
            this.url = shareBean.getParams().getUrl() + "?extcode=" + code;
        }else {
        ...
        llSina.setOnClickListener(this);
        llPage.setOnClickListener(this);
//        if(shareBean != null && shareBean.getIsCreatedPoster() == 1){
        if(SPUtils.getInstance().getBoolean(Constant.IS_LOGIN)){
...
//        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.ll_share_cut_sina:
                sharePlatform(SHARE_MEDIA.SINA);
                dismiss();
                break;

            case R.id.ll_share_cut_page:
