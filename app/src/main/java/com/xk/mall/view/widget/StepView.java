...
import com.xk.mall.view.widget.item.StepNodeItemDecoration;
...
public class StepView extends RecyclerView {
    ...
    public StepView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        leftMargin = ConvertUtils.dp2px(DEFAULT_LEFT_MARGIN);
        rightMargin = ConvertUtils.dp2px(DEFAULT_RIGHT_MARGIN);
        lineWidth = ConvertUtils.dp2px(DEFAULT_LINE_WIDTH);
        radius = ConvertUtils.dp2px(DEFAULT_DOT_RADIUS);
...
//        );
    ...
    private class StepAdapter extends Adapter<StepViewHolder> {
        ...
        public void onBindViewHolder(StepViewHolder holder, int position) {
            ...
            if (mListener != null) {
                mListener.onBindView(holder.itemMsg, holder.itemDate, data, position);
            }
        }
    ...
    public static interface BindViewListener {
        void onBindView(TextView itemMsg, TextView itemDate, Object data, int pos);
    }
