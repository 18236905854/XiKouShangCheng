 ...
 * Version V1.0
 */
public class DialogShare extends BottomSheetDialog implements View.OnClickListener, UMShareListener {
    ...
    public DialogShare(@NonNull Context context, ShareBean shareBean) {
        super(context);
        this.mContext = context;
