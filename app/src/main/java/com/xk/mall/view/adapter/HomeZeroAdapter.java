 ...
 * 首页0元拍 adapter
 */
public class HomeZeroAdapter extends  RvAdapter<HomeBean.HomeAuctionActivityModelBean.HomeAuctionCommodityModels>{
    ...
    public HomeZeroAdapter(Context context, List<HomeBean.HomeAuctionActivityModelBean.HomeAuctionCommodityModels> list, RvListener listener) {
...
//    }
    ...
    private class HomeWuGGoodsHolder extends RvHolder<HomeBean.HomeAuctionActivityModelBean.HomeAuctionCommodityModels>{
        ...
        @Override
        public void bindHolder(HomeBean.HomeAuctionActivityModelBean.HomeAuctionCommodityModels bean, int position) {
            GlideUtil.showRadius(mContext,bean.getGoodsImageUrl(),5,img_wug_goods);
            tv_goodsName.setText(bean.getCommodityName());
//            tv_sale_price.setText(String.valueOf(PriceUtil.dividePrice(bean.getStartPrice())));
            tv_sale_price.setText("0");
