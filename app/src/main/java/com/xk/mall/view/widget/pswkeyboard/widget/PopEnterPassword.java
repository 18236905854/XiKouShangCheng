...
public class PopEnterPassword extends PopupWindow {
    ...
    private OnSetPwdListenner onSetPwdListenner;

    public void setOnSetPwdListenner(OnSetPwdListenner onSetPwdListenner) {
        this.onSetPwdListenner = onSetPwdListenner;
    }
    ...
    public PopEnterPassword(final Activity context) {
        ...
        pwdView.setOnFinishInput(new OnPasswordInputFinish() {
            ...
            public void inputFinish(final String password) {
                onFinishInputListener.onFinish(password);
...
//                }).start();
        ...
        //重置密码
        pwdView.getTvSetPassWord().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                onSetPwdListenner.OnSetPwd();
            }
        });
    ...
    public interface  OnSetPwdListenner{
        void OnSetPwd();
    }
}
