...
import com.xk.mall.view.widget.pswkeyboard.adapter.KeyBoardAdapter;
...
public class PasswordView extends RelativeLayout {
    ...
    private TextView tvSetPassWord;//重置密码
    ...
    public PasswordView(Context context, AttributeSet attrs) {
        ...
        imgCancel = (ImageView) view.findViewById(R.id.img_cha);
        tvSetPassWord =  view.findViewById(R.id.tv_set_pwd);
