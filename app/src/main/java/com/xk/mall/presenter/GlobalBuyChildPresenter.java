 ...
 * Description 全球买手子页面请求Presenter
 * Author 卿凯
 * Date 2019/7/30/030
 * Version V1.0
 */
public class GlobalBuyChildPresenter extends BasePresenter<GlobalBuyChildViewImpl> {

    public GlobalBuyChildPresenter(GlobalBuyChildViewImpl baseView) {
        super(baseView);
    }
