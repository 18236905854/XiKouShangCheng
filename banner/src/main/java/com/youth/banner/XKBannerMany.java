...
public class XKBannerMany extends FrameLayout implements OnPageChangeListener {
    public String tag = "banner";
    private int mIndicatorMargin = BannerConfig.PADDING_SIZE2;
    ...
    private int mLayoutResId = R.layout.xk_banner_many;
    ...
    public XKBannerMany(Context context) {
        this(context, null);
    }

    public XKBannerMany(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XKBannerMany(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mIndicatorMargin = typedArray.getDimensionPixelSize(R.styleable.Banner_indicator_margin, BannerConfig.PADDING_SIZE2);
    ...
    public XKBannerMany isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public XKBannerMany setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public XKBannerMany setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public XKBannerMany setIndicatorGravity(int type) {
        switch (type) {
    ...
    public XKBannerMany setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public XKBannerMany setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public XKBannerMany setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public XKBannerMany setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public XKBannerMany setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public XKBannerMany setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public XKBannerMany setImages(List<?> imageUrls) {
...
//            LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(M, mIndicatorHeight); 改成自适应
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public XKBannerMany setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public XKBannerMany setOnBannerListener(OnBannerListener listener) {
