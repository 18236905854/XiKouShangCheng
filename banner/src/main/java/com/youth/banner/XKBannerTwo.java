...
public class XKBannerTwo extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.xk_banner_home;
    ...
    public XKBannerTwo(Context context) {
        this(context, null);
    }

    public XKBannerTwo(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public XKBannerTwo(Context context, AttributeSet attrs, int defStyle) {
    ...
    public XKBannerTwo isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public XKBannerTwo setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public XKBannerTwo setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public XKBannerTwo setIndicatorGravity(int type) {
        switch (type) {
    ...
    public XKBannerTwo setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public XKBannerTwo setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public XKBannerTwo setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public XKBannerTwo setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public XKBannerTwo setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public XKBannerTwo setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public XKBannerTwo setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public XKBannerTwo setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public XKBannerTwo setOnBannerListener(OnBannerListener listener) {
