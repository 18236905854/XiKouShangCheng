...
public class XKBanner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.xk_banner;
    ...
    public XKBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public XKBanner isAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public XKBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public XKBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public XKBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public XKBanner setBannerAnimation(Class<? extends PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public XKBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public XKBanner setPageTransformer(boolean reverseDrawingOrder, PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public XKBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public XKBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public XKBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public XKBanner setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public XKBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public XKBanner setOnBannerListener(OnBannerListener listener) {
