...
import com.youth.banner.listener.OnMaterialBannerClickListener;
...
public class MaterialBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private OnMaterialBannerClickListener listener;
    ...
    public MaterialBanner(Context context, AttributeSet attrs, int defStyle) {
    ...
    public MaterialBanner setAutoPlay(boolean isAutoPlay) {
        this.isAutoPlay = isAutoPlay;
        return this;
    }

    public MaterialBanner setLoop(boolean isLoop) {
        this.isLoop = isLoop;
        return this;
    }

    public MaterialBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public MaterialBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public MaterialBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
    ...
    public MaterialBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public MaterialBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public MaterialBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public MaterialBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public MaterialBanner setCurrentPage(@IntRange(from = 0) int page) {
        mCurrentPage = page;
        return this;
    }

    public MaterialBanner setPages(List<?> datas, BannerViewHolder creator) {
        this.mDatas.clear();
    ...
    public MaterialBanner setIndicatorRes(int select, int unSelect) {
        if (select < 0)
    ...
    public MaterialBanner setIndicatorRes(Drawable select, Drawable unSelect) {
    ...
    public MaterialBanner setOnBannerClickListener(OnMaterialBannerClickListener listener) {
